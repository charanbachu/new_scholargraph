...
<head>
	<meta charset="utf-8">
	<title>Country Specific Tree</title>
	...
	<?php
	function tree($child_node,$child_name,$child_ques,$child_ansop,$child_nodetype,$node_flag,$node_pos,$child,$string,$country,$question,$option_content)
	{
		echo '<ul>';
		for($j=0;$j<sizeof($child_node);$j++)
	    {
		        	...
		        	else
		        	{
			            ...
			            if($string[$pos] == 0)
			            {
			            	echo anchor('main/enable_coun_bit/'.$pos.'/'.$country,'Enable',array('style'=>'color:red;font-weight:bold'));
			            	echo ',';
			            }
			            else
			            {
			            	echo anchor('main/disable_coun_bit/'.$pos.'/'.$country,'Disable',array('style'=>'color:#009933;font-weight:bold'));
			            	echo ',';
			            }
	        		...
	        		if($flag == 1)
	        		{
	        			$node_flag = tree($child_node1,$child_name1,$child_ques1,$child_ansop1,$child_nodetype1,$node_flag,$node_pos,$child,$string,$country,$question,$option_content);
			            echo '</li>';
	        		}
		}
		echo '</ul>';
...
<div id="container">
	...
	if($string[0] == -1)
	{
		echo '<center><h3>Change Country Bit String</h3></center>';
		 echo '<br>';
		 $data1 = array(
		 'name'  => 'country_code',
		 'id'    => 'country_code'
		...
		<nav class="navbar navbar-default navbar-fixed-top">
		  <div class="container-fluid">
		    ...
		    <div class="navbar-header navbar-middle">
		      <a class="navbar-brand" href="#">Country Tree</a>
		...
		for($i=0;$i<sizeof($node);$i++)
		{
			if($node_flag[$i] == 0)
			{
		       ...
		       echo ', Type:';
	        	...
	        	$node_flag = tree($child_node,$child_name,$child_ques,$child_ansop,$child_nodetype,$node_flag,$node_pos,$child,$string,$country,$question,$option_content);
		        echo '</li>';
