...
<head>
	<meta charset="utf-8">
	<title>Insert Structural nodes</title>
	...
	<?php
	function tree($child_node,$child_name,$child_ques,$child_ansop,$child_nodetype,$node_flag,$node_pos,$child,$question,$option_content,$string,$country)
	{
		echo '<ul>';
		for($j=0;$j<sizeof($child_node);$j++)
	    {
        	...
        	else
        	{
	           ...
	           if($child_nodetype[$j] == 'Structural')
	            ...
	            if($string[$pos] == 0)
	            {
	            	echo anchor('main/enable_glob_bit/'.$pos.'/'.$country,'Enable',array('style'=>'color:red;font-weight:bold'));
	            
	            }
	            else
	            {
	            	echo anchor('main/disable_glob_bit/'.$pos.'/'.$country,'Disable',array('style'=>'color:#009933;font-weight:bold'));
    		...
    		if($flag == 1)
    		{
    			$node_flag = tree($child_node1,$child_name1,$child_ques1,$child_ansop1,$child_nodetype1,$node_flag,$node_pos,$child,$question,$option_content,$string,$country);
	            echo '</li>';
    		}
	...
	<nav class="navbar navbar-default navbar-fixed-top">
	  <div class="container-fluid">
	    ...
	    <div class="navbar-header navbar-middle">
	      <a class="navbar-brand" href="#">Node Tree</a>
	    </div>
			...
			if($node_flag[$i] == 0)
			{
		       ...
		       // echo '<span><i class="icon-folder-open"></i>';
		        ...
		        if($node_ansop[$i] == NULL)
		        {
		        	...
		        	echo '<br>'.$node_ques[$i].'.'.$question[$ques];
		        }
		        echo '</span>';
	        	$childnode = $child[$i];
	        	...
	        	$node_flag = tree($child_node,$child_name,$child_ques,$child_ansop,$child_nodetype,$node_flag,$node_pos,$child,$question,$option_content,$string,$country);
		        echo '</li>';
