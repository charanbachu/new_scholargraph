    ...
    <body>
        ...
        <app-drawer-layout fullbleed responsive-width="1024px">
          ...
          <!-- <li></li> -->
                ...
                <div id="container" class="flex-container-desktop" style="display: flex; justify-content: center;">
                    
                    <div class="flex-desktop" style="width:375px">
                    ...
                    <div id="addcolleges"> 
                    <?php
                        foreach($userColleges as $coll)
                        {
                            echo '<div class="table-container" ><div id="fillRequest" style="background-color:#4caf50" aria-controls="form3"><div id="message">'.$coll->name.'</div><div id="edit2"><em>'.$coll->major.','.$coll->degree.'</em></div></div></div>';
                        }
                    ?>
                    ...
                    <?php
                        ...
                        for($i=0;$i<1;$i++)
                        {
                            echo '<div class="table-container" id="here">';
                            if(!empty($college))
                            {
                                            ...
                                            <table>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div id="collegeSearchResults" style="margin: 0px;">
                                                        </div>';
                                                        }
                                                        else
                                                        {
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a href="#here">
                                                        <paper-radio-group aria-labelledby="Position" id = "member-select" style="padding-top: 0px; padding-bottom: 0px;">
                                                        <paper-radio-button style="padding-top: 0px;padding-left:8px; padding-right:8px;" name="student">Student</paper-radio-button>
                                                        <paper-radio-button style="padding-top: 0px;" name="alumni">Alumni</paper-radio-button>
                                                        <paper-radio-button style="padding-top: 0px;" name="faculty">Faculty</paper-radio-button>
                                                        </paper-radio-group></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <paper-button class = "submitButtonSmall" id="subButton1" onclick=submitCollegeForm("#form'.$i.'") style = "font-size: 15px; " >
                    ...
                    <div id = "addMoreCollege" >
                        <iron-icon icon="add-circle-outline" prefix style="width: 45px; height: 45px;"></iron-icon><span style="font-size: 24px;">Add Additional College</span>
                    </div>
                        <!-- <paper-button class = "editButtonSmall" id="editButton"  >
                                    <iron-icon icon="icons:check" "></iron-icon>Edit Info
                                    </paper-button> -->
                    <div class="noad"><paper-button class = "updateButtonSmall" id="updateButton" onclick="nextPage()">
                                    <!-- <iron-icon icon="icons:check" "> </iron-icon>-->Next
                                    </paper-button>
                                    </div>
                </div>
            </div>                  
            ...
            $.ajax({
                    ...
                    success: function(data)
                    {
                        ...
                        if(message == "")
                        {
                            ...
                            if(document.getElementById("myNav").style.display == "inline-block")
                            {
                                document.getElementById("college").style.visibility = "visible";
                                document.getElementById("college").style.display = "inline-block";
                                document.getElementById("college-id").style.visibility = "visible";
                                document.getElementById("college-id").style.display = "inline-block";
