...
<head>
	...
	<?php
	function tree($child_node,$child_name,$child_ques,$child_ansop,$child_nodetype,$node_flag,$node_pos,$child,$question,$option_content,$country)
	{
		echo '<ul>';
		for($j=0;$j<sizeof($child_node);$j++)
	    {
	        		...
	        		if($flag == 1)
	        		{
	        			$node_flag = tree($child_node1,$child_name1,$child_ques1,$child_ansop1,$child_nodetype1,$node_flag,$node_pos,$child,$question,$option_content,$country);
			            echo '</li>';
	        		}
		}
		echo '</ul>';
...
<nav class="navbar navbar-default navbar-fixed-top">
	  <div class="container-fluid">
	    ...
	    <div class="navbar-header navbar-middle">
	      <a class="navbar-brand" href="#">Attribute Tree</a>
	    </div>
	...
	echo '<!-- Modal -->
		...
		echo '<center><h3>Attribute Tree </h3></center>';
		...
		for($i=0;$i<sizeof($node);$i++)
		{
			if($node_flag[$i] == 0)
			{
	        	...
	        	$node_flag = tree($child_node,$child_name,$child_ques,$child_ansop,$child_nodetype,$node_flag,$node_pos,$child,$question,$option_content,$country);
		        echo '</li>';
