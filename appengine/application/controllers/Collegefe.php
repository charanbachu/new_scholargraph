...
class Collegefe extends CI_Controller {
/* */
	/*
	...
	*/
	public function test()
	{
		...
		$this->load->view('college_profilefe',array('jsons'=>json_encode($tree)));
	}
	...
	*/
	public function details($collegeid = -1)
	{
		...
		else
		{
			...
			$this->load->view('college_profilefe',array('jsons'=>$jsons,'collegeid'=>$collegeid,'college'=>$college,'flag'=>$flag));
